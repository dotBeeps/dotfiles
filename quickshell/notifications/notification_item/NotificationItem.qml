...
Rectangle {
    ...
    opacity: 0
    color: notiMouseArea.containsMouse ? Config.colors.highlightOverlay : "transparent"
    ...
    NotificationAppHint {
        ...
        anchors {
            top: parent.top
            right: parent.right
            topMargin: Config.gapSm / 2
            rightMargin: Config.gapSm
        }
    ...
    ColumnLayout {
        ...
        NotificationBody {
            ...
            Layout.margins: Config.gapSm / 2
            Layout.leftMargin: Config.gapSm
            Layout.rightMargin: Config.gapSm
